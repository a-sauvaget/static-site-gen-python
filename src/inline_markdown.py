...
def split_nodes_image(old_nodes: list) -> list:
    '''Return a list of new nodes, where images in the input list are split into multiple node based on the syntax.'''
    new_nodes = []
    for old_node in old_nodes:
        if old_node.text_type != TextType.TEXT:
            new_nodes.append(old_node)
...
def split_nodes_link(old_nodes: list) -> list:
    '''Return a list of new nodes, where links in the input list are split into multiple node based on the syntax.'''
    new_nodes = []
    for old_node in old_nodes:
        if old_node.text_type != TextType.TEXT:
            new_nodes.append(old_node)
